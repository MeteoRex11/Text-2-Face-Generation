...
Text-to-Face generation using Deep Learning, based on the work done by [akanimax](https://github.com/akanimax/T2F/commits?author=akanimax). 
This project combines two architectures <a href="https://arxiv.org/abs/1710.10916"> StackGAN </a> and <a href="https://arxiv.org/abs/1710.10196"> ProGAN </a> for synthesizing faces from textual descriptions.<br>
